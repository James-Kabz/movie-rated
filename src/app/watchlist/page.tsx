...
import { TrashIcon, CheckIcon, FilmIcon, TvIcon } from "@heroicons/react/24/outline"
...
export default function WatchlistPage() {
  ...
  const getDetailUrl = (item: WatchlistItem) => {
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-6 text-sm">
          <div className="flex items-center gap-1 px-3 py-1 bg-gray-100 rounded-full">
            <span className="font-medium text-gray-600">Total: {stats.total}</span>
          </div>
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <Link href={getDetailUrl(item)}>
                    <h3 className="text-lg font-semibold hover:text-indigo-600 transition-colors">{item.movieTitle}</h3>
                  </Link>
